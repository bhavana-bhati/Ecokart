...
<aside class="filters">
    ...
    <ul class="filter-list">
      ...
      <li><input type="radio" name="price" value="300to500"> <label>₹300–₹500</label></li>
      <li><input type="radio" name="price" value="above500"> <label>Above ₹500</label></li>
    </ul>
</aside>
...
function filterProducts(){
  ...
  cards.forEach(card => {
    ...
    let matchPrice =
      ...
      (filter === "300to500" && price >= 300 && price <= 500) ||
      (filter === "above500" && price > 500);
