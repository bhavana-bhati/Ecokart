...
<aside class="filters">
    ...
    <ul class="filter-list">
      ...
      <li><input type="radio" name="price" value="under3000"> <label>Under ₹3000</label></li>
      <li><input type="radio" name="price" value="3000to10000"> <label>₹3000–₹10000</label></li>
      <li><input type="radio" name="price" value="above10000"> <label>Above ₹10000</label></li>
    </ul>
</aside>
...
function filterProducts(){
  ...
  cards.forEach(card => {
    ...
    let matchPrice =
      filter === "all" ||
      (filter === "under3000" && price < 3000) ||
      (filter === "3000to10000" && price >= 3000 && price <= 10000) ||
      (filter === "above10000" && price > 10000);
